...
| ----------------------------- | ------ | -------- | ------------------------------------------------ | -------------------------------- | ------------------------------------------------ |
| author                        | string | Yes      | Author name.                                     |                                  | `"Marylia Cruz"`                                     |
| info                          | string | Yes      | An headline, job title or similar.               |                                  | `"Political Science"`                         |
| description                   | string | Yes      | Description of the site.                         |                                  | `"Marylia Cruz's personal website"`                  |
| keywords                      | string | Yes      | Site keywords.                                   |                                  | `"blog,developer,personal"`                      |
| avatarURL                     | string | No       | Photo of the author.                             |                                  | `"images/avatar.jpg"`                            |
| gravatar                      | string | No       | Gravatar photo of the author                     |                                  | `"marylia.cruz@pucp.edu.pe"`                         |
...
| url            | string | Yes      | URL to redirect.                         | `"https://github.com/maryliacruzsarmiento/"` |
...
[[params.social]]
  ...
  weight = 1
  url = "https://github.com/maryliacruzsarmiento/"
[[params.social]]
  name = "Gitlab"
...
[[params.social]]
  ...
  weight = 3
  url = "https://twitter.com/MaryliaCruz/"
```
